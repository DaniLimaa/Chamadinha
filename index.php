...
<!-- link do bootstrap para exportação de frameworks, button, estilizações -->
<?php

$dsn = 'mysql:dbname=bd_chamadinha;host=127.0.0.1';
// local onde o banco está
$user = 'root';
// quem esta acessando o banco
$password = '';
// onde seria a senha, mas não tem

$banco = new PDO($dsn, $user, $password);
// variável que junta todas as informações do banco
